 ...
 */
export default {
  'component.plugin.tip1': 'NOTA: Depois de personalizar o plug-in, você precisa atualizar o schema.json.',
  ...
  'component.pluginForm.api-breaker.healthy.http_statuses.tooltip': 'Códigos de status quando saudáveis.',
  ...
  'component.pluginForm.proxy-mirror.path.ruletip': 'Por favor, insira o caminho correto, por exemplo /path',
