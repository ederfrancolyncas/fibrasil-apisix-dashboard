...
export default {
  ...
  'component.upstream.fields.keepalive_pool.tooltip': 'Definir pool de keepalive independente para Upstream',
  ...
  'component.upstream.fields.checks.active.https_verify_certificate': 'Verifique o certificado HTTP',
  ...
  'component.upstream.fields.checks.active.unhealthy.required':
    'Insira o intervalo não saudável',
  ...
  'component.upstream.other.health-check.invalid': 'Verifique a configuração da verificação de integridade',
};
