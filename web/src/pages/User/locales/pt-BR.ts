...
export default {
  ...
  'component.user.loginMethodPassword': 'Usuário & Senha',
  'component.user.loginMethodPassword.username': 'Usuário',
  'component.user.loginMethodPassword.password': 'Senha',
  'component.user.loginMethodPassword.inputUsername': 'Insira o nome de usuário',
