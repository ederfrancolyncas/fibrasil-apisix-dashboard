...
export default {
  ...
  'page.route.caseInsensitiveRegexMatch': 'Correspondência regular que não diferencia maiúsculas de minúsculas (~*)',
  'page.route.in': 'EM',
  'page.route.has': 'TEM',
  ...
  'page.route.input.placeholder.parameterNameHttpHeader': 'Nome do cabeçalho da solicitação, por exemplo: HOST',
  ...
  'page.route.panelSection.title.advancedMatchRule': 'Condições Avançadas de Correspondência de Roteamento',
  ...
  'page.route.tooltip.pluginOrchOnlySupportChrome': 'A orquestração de plug-in é compatível apenas com o Chrome.',
  ...
  'page.route.advanced-match.operator.sample.~~': 'Insira uma expressão regular, por exemplo [a-z]+',
  ...
  'page.route.advanced-match.tips.requestParameter': 'Parâmetro de solicitação: Consulta da URL da solicitação',
  ...
  'page.route.fields.custom.redirectOption.tooltip': 'Isso está relacionado ao plug-in de redirecionamento',
  'page.route.fields.service_id.tooltip': 'Vincular objetos de serviço para reutilizar sua configuração.',

  'page.route.fields.vars.invalid': 'Verifique a configuração avançada da condição de correspondência',
